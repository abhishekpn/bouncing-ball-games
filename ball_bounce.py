...
background=pygame.image.load('Bouncing ball game/background-img.jpg')

#Adding title
pygame.display.set_caption("Ball Bounce Simulation")

class ball:
    ball_image = pygame.image.load('Bouncing ball game/ball.png')
    g = 1
    def __init__(self):
        self.velocityX=4
        self.velocityY=4
    ...
    def move_ball(self):
        ...
        if self.Y>568 and self.velocityY>0:
            self.velocityY*=-1
            self.Y=568
#list of balls created as object
Ball_List = [ball(),ball(),ball(),ball(),ball(),ball()]
